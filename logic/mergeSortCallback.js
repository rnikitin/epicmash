const merge = (arrFirst, arrSecond) => {
    ...
    while (i < arrFirst.length && j < arrSecond.length) {
        arrSort.push(
            (arrFirst[i] < arrSecond[j]) ?  // TODO: вот этот шаг надо перевесить на пользователя
...
export const mergeSort2 = (arr, callback) => {
    ...
    return merge(mergeSort2(arrLeft), mergeSort2(arrRight));;
};